...
void Tutorial02_Cube::CreateVertexBuffer()
{
    ...
    // Cube vertices + Inverted Pyramid vertices

   constexpr Vertex CubeVerts[15] =
        {
            {float3{0, 0, 0}, float4{1, 0, 0, 1}},      // 0 - A
            {float3{+1, +1, -1}, float4{1, 0, 0, 1}},   // 1 - B
            {float3{-1, +1, -1}, float4{1, 0, 0, 1}},   // 2 - C
            {float3{+1, +1, +1}, float4{1, 0, 0, 1}},   // 3 - D
            {float3{-1, +1, +1}, float4{1, 0, 0, 1}},   // 4 - E
            {float3{0, 2, 0}, float4{1, 0, 0, 1}},      // 5 - F
            {float3{+2, +2, +1}, float4{1, 0, 0, 1}},   // 6 - G
            {float3{+2, +2, -1}, float4{1, 0, 0, 1}},   // 7 - H
            {float3{-2, +2, +1}, float4{1, 0, 0, 1}},   // 8 - I
            {float3{-2, +2, -1}, float4{1, 0, 0, 1}},   // 9 - J
            {float3{+1, +3, 0}, float4{1, 0, 0 , 1}},   // 10 - k
            {float3{-1, +3, 0}, float4{1, 0, 0, 1}},    // 11 - l
            {float3{0, 2, -1}, float4{1, 0, 0, 1}},     // 12-m
            {float3{0, 2, 1}, float4{1, 0, 0, 1}},      // 13-n
        };

    // Create a vertex buffer that stores cube and pyramid vertices
    BufferDesc VertBuffDesc;
    VertBuffDesc.Name      = "Cube and Pyramid vertex buffer";
...
void Tutorial02_Cube::Update(double CurrTime, double ElapsedTime)
{
    ...
    float4x4 View = float4x4::Translation(0.f, 0.0f, 10.0f);
